...
func TestAlignCenter(t *testing.T) {
	wrapspec := &textfmt.WrapSpec{Width: 10, Align: textfmt.Center, PadChar: ' '}
...
func TestAlignRight(t *testing.T) {
	wrapspec := &textfmt.WrapSpec{Width: 10, Align: textfmt.Right, PadChar: ' '}
...
func TestAlignmentVaryingWidths(t *testing.T) {
	wrapspec := &textfmt.WrapSpec{Width: 15, Align: textfmt.Center, PadChar: ' '}
	input := "Center Align"
	expected := []string{" Center Align  "}
	GenericWrapTestFunction(t, "Center alignment with varying width", wrapspec, input, expected, "")

	wrapspec = &textfmt.WrapSpec{Width: 15, Align: textfmt.Right, PadChar: ' '}
	expected = []string{"   Center Align"}
